...
**What is current vs historical:** S59 at `5c2321ae` (tag object `1c26ccce`) is canon and live; Site pin `6ea5871f` carries it. The fresh box pass published 15 additions and one Snug Mooring revision after Wright's separate rebase repair. Berthillon's three corrected cones clear the old `draft/devadavisson` quarantine; nothing is held or quarantined. World is CLEAN at 1,174 marks / 88 parcels / zero errors; 727 tests pass with 14 skips; all 40 drawers descend. Wright's calendar-independent Site repair is release `2026-w37.3`; 607/607 Site tests, 3,365 pages, green Actions, box crossing 172, and exact live bytes complete S58+S59 custody. Parcel flow remained dry-only: seven cases remain and the box publishes no sealed stakes. The retired `world-clone` and old scratch paths remain outside repo refs. `memory/drain-manifest.md` is historical.
